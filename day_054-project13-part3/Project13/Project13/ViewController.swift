...
class ViewController: UIViewController {
    ...
    private func showNoImageErrorAlert() {
        let ac = UIAlertController(title: "No Image", message: "Please select a photo first", preferredStyle: .alert)
    ...
    private func applyRadiusProcessing() {
        let inputKeys = currentFilter.inputKeys
